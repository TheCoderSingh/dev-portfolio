			...
			<Box className="inner">
				...
				<Box className="projects-1-col">
					...
					<Box className="project">
						...
						<Text className="project-description">
							Aura displays the air quality of the location you
							are planning to travel to and tells you whether it
							is safe to travel or not and provides you with a
					...
					<Box className="project">
						...
						<Text className="project-description">
							Get hotels available near you with all the
							information including amenities, check-in &amp;
							check-out times, room photos and guest rating.
						</Text>
						<Flex className="project-technologies">
							<Text>HTML5</Text>
							<Text>CSS3</Text>
				...
				<Flex className="projects-2-cols" justifyContent="space-evenly">
					<Box className="project">
						<Image
							src={alunos}
							alt="alunos"
				...
				<Flex className="projects-3-cols" justifyContent="space-evenly">
					<Box className="project">
						<Image
							src={alunos}
							alt="alunos"
